...
export default function HomePage() {
  ...
  const solutions = [
    ...
    },
    {
      ...
      description: 'Communication systems, air navigation systems and aircraft surveillance system. It is an essential system for pilots and air traffic controllers.',
  ...
  const bestProducts = [
    {
      ...
      description: 'The Cloud has transformed into a foundational infrastructure for businesses, and the migration of traditional IT systems to the Cloud has become one of the top strategic priorities for businesses worldwide.',
    ...
    },
    {
      ...
      tag2: 'Cloud',
      description: 'While the concept of Cloud computing may present the idea of an on-demand convenience, the actual use of Cloud services comes with many challenges due to the complexity arising from multiple providers.',
    ...
    },
    {
      ...
      tag2: 'Security',
      description: 'The Zero Trust concept has gained widespread adoption as a fundamental security strategy for corporate IT systems, implementing protocols that restrict access to Business Application systems and Data.',
          ...
          {solutions.map((solution, index) => (
            <ScrollReveal key={solution.slug} delay={index * 0.05}>
              <Link href={`/solutions/${solution.slug}`}>
                <div className="border-b border-neutral-200 py-8 transition-all cursor-pointer group relative overflow-hidden">
                  <div
                  ...
                  />
                  <div className="absolute inset-0 bg-neutral-800/30 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                  <div className="container mx-auto px-8 max-w-7xl relative z-10">
                    <div className="flex items-start gap-12">
                      <h3 className="text-xl font-medium w-1/3 text-neutral-800 group-hover:text-white transition-colors">
                        {solution.name}
                      </h3>
                      <p className="text-neutral-500 w-2/3 text-base group-hover:text-neutral-200 transition-colors">
